...
from llava.http_bot import http_bot, add_text
...
def load_demo_refresh_model_list(request: gr.Request):
    logger_app.info(f"load_demo. ip: {request.client.host}")
    ...
    with gr.Blocks(title="MQ-GPT", theme=gr.themes.Default(), css=block_css) as demo:
        ...
        with gr.Row():
            with gr.Column(scale=3):
                ...
                with gr.Accordion("Reference Image", open=False, visible=True) as ref_image_row:
                    gr.Markdown(
